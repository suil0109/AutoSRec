...
def create_matrix(data1, users_col, items_col, ratings_col, threshold=None):
    """
...
class BPR:
    ...
    def fit(self, ratings):
        ...
        indptr = ratings.indptr # indptr: [0 42 75] -> index 0-42: user1, index 42-75: user2
        indices = ratings.indices # indices [0 1 5 10 2 4 6 10] -> column index of all positive rating
    ...
    def _sample(self, n_users, n_items, indices, indptr):
        ...
        sampled_users = np.random.choice(
            n_users, size=self.batch_size, replace=True)
        # sampled_users: userID
        # indices: index of all positive columns: movieID
        # indptr: [0 42 75] -> index 0-42: user1, index 42-75: user2: userID
        ...
        # print(sampled_users,'hi', sampled_pos_items, 'hi', sampled_neg_items,'hey')
        # print(np.in1d(sampled_pos_items, sampled_neg_items))
        # print(np.intersect1d(sampled_pos_items, sampled_neg_items))
