...
path = os.path.join('./example_datasets/lastfm/userid-timestamp-artid-artname-traid-traname.tsv')
...
def generate_data():
    ...
    data = pd.read_csv(path, sep='\t',
                       header=0,
                       names=['userid', 'timestamp', 'artid', 'artname', 'traid', 'tranname'], nrows=10, engine='python')
