...
print(train_X_categorical.shape)
...
from autorecsys.pipeline.interactor_ts import MLPInteraction, TransformerBlock, TokenAndPositionEmbedding
...
output11 = MLPInteraction()([dense_input_node, sparse_input_node])
# output1 = MLPInteraction()([output11])

# output2 = TokenAndPositionEmbedding(maxlen=1000, vocab_size=20000)([output11])
# output5 = TransformerBlock()([output2])
output5 = SelfAttentionInteraction()([output11])

# output1 = GRUInteractor()([dense_input_node])
# output2 = GRUInteractor()([sparse_input_node])


# output3 = MLPInteraction()([output1])
# output5 = MLPInteraction()([output4])
...
# output3 = ak.ClassificationHead()(output1)
#
#
...
# eval = Eval_Topk(pred=b[0], data=val_X, topk=5, timestep=timestep)
